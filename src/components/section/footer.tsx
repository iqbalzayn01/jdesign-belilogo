      ...
      <footer className="bg-[#2A2B35]">
        <div className="container mx-auto px-5 py-16 lg:py-32">
          <div className="flex flex-col lg:flex-row items-start justify-center gap-10 lg:gap-20">
            <div className="flex max-w-[480px] flex-col text-white gap-3">
              <h2 className="text-[22px]">What's new?</h2>
              <p className="text-sm">
            ...
            <NavigationMenu>
              <NavigationMenuList className="grid gap-3">
                <span className="md:text-nowrap text-[22px] text-white">
                  FAQ & Question
                </span>
                {dataFAQQuestion.map((link, index) => {
                  return (
                    <NavigationMenuItem key={index}>
                      <Link to={link.href} className="text-sm text-white">
                        {link.name}
                      </Link>
                    </NavigationMenuItem>
                  );
            ...
            <div className="flex w-full lg:max-w-[200px] flex-col gap-3">
              <span className="text-[22px] text-white">Address</span>
